...
import org.sfchristadelphian.readings.fragment.PassageFragment;
import org.sfchristadelphian.readings.model.ParcelableReadings;
import org.sfchristadelphian.readings.service.IPlayerUi;
...
public class PassageActivity extends BaseActivity implements IPlayerUi {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.menu_brightness || id == R.id.menu_brightness_overflow) {
            doDayNightToggle();
            return true;
        } else if (id == R.id.menu_about_content) {

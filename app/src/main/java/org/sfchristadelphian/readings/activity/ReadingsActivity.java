...
package org.sfchristadelphian.readings.activity;
...
import org.sfchristadelphian.readings.fragment.DatePickerFragment;
...
public class ReadingsActivity extends BaseActivity implements OnDateSetListener {
    ...
    private String backgroundDownloadNewsToast(String versionName) {
        ...
        try {
            ...
            if(line != null) {
                if(line.equals("org.sfchristadelphian.readings.news-toast")) {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if ( id == R.id.menu_brightness || id == R.id.menu_brightness_overflow) {
            doDayNightToggle();
            return true;
    ...
    private void doRate() {
        startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://play.google.com/store/apps/details?id=org.sfchristadelphian.readings")));
    }

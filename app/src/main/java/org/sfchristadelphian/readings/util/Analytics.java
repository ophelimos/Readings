package org.sfchristadelphian.readings.util;

import org.sfchristadelphian.readings.R;
import org.sfchristadelphian.readings.activity.BaseActivity;
    ...
    public static void reportCaughtException(Context context, Exception e) {
        if (isEnabled(context)) {
            ...
            for(int i=0;i<stackTraceElements.length; i++) {
                ...
                if(stackTraceElement.getClassName().contains("sfchristadelphian")) {
